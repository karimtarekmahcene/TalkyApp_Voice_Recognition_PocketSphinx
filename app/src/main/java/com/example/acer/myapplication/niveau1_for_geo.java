...
public class niveau1_for_geo extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="en") {
            ...
            if (count == 1) {
                img.setImageResource(R.drawable.alg_flag);
            } else if (count == 2) {
                img.setImageResource(R.drawable.french_flag);
            } else if (count == 3) {
                img.setImageResource(R.drawable.spain_flag);
            } else if (count == 4) {
                img.setImageResource(R.drawable.canada_flag);
            } else if (count == 5) {
                img.setImageResource(R.drawable.italy_flag);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau1_for_geo.this, Slide_for_geo.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau1_for_geo.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer algeria = MediaPlayer.create(this,R.raw.algeria);
        final MediaPlayer french = MediaPlayer.create(this,R.raw.french);
        final MediaPlayer spain = MediaPlayer.create(this,R.raw.spain);
        final MediaPlayer canada = MediaPlayer.create(this,R.raw.canada);
        final MediaPlayer italy = MediaPlayer.create(this,R.raw.italy);


        final MediaPlayer algeria_fr = MediaPlayer.create(this,R.raw.algeria_fr);
        final MediaPlayer french_fr = MediaPlayer.create(this,R.raw.french_fr);
        final MediaPlayer spain_fr = MediaPlayer.create(this,R.raw.spain_fr);
        final MediaPlayer canada_fr = MediaPlayer.create(this,R.raw.canada_fr);
        final MediaPlayer italy_fr = MediaPlayer.create(this,R.raw.italy_fr);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau1_for_geo> activityReference;
        SetupTask(niveau1_for_geo activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("algeria")) {
                    ...
                    database.updateData("algeria",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("algeria");
                    c.moveToFirst();
                ...
                if (text.equals("french")) {
                    ...
                    database.updateData("french",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("french");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("spain")) {
                    ...
                    //  makeText(getApplicationContext(), ""+text+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("spain",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("spain");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("canada")) {
                    ...
                    //  makeText(getApplicationContext(), ""+text+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("canada",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("canada");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("italy")) {
                    ...
                    // makeText(getApplicationContext(), ""+text+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("italy",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("italy");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));

                    int scoreniveauENG=TotalScore/5;

                    database.updateDataNiv("niv1cat4",login_activite.nom,scoreniveauENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("algérie")) {
                    ...
                    //  makeText(getApplicationContext(), "" +text+" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("algeria",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("france")) {
                    ...
                    Toasty.success(this, "" + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("french",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("espagne")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("spain",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("canada")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("canada",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("italie")) {
                    ...
                    // makeText(getApplicationContext(), ""+text+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("italy",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv1cat4",login_activite.nom,scoreniveauFR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File chatGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
        recognizer.addGrammarSearch(CHAT_SEARCH, chatGrammar);

        File chienGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
        recognizer.addGrammarSearch(CHIEN_SEARCH, chienGrammar);

        File lionGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
        recognizer.addGrammarSearch(LIONFR_SEARCH, lionGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
        recognizer.addGrammarSearch(CHEVAL_SEARCH, chevalGrammar);

        File vacheGrammar = new File(assetsDir,"niveau_un_geo_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File catGrammar = new File(assetsDir,"niveau_1_geo_en.gram");
        recognizer.addGrammarSearch(CAT_SEARCH, catGrammar);

        File DogGrammar = new File(assetsDir,"niveau_1_geo_en.gram");
        recognizer.addGrammarSearch(DOG_SEARCH, DogGrammar);

        File LionGrammar = new File(assetsDir,"niveau_1_geo_en.gram");
        recognizer.addGrammarSearch(LION_SEARCH, LionGrammar);

        File HorseGrammar = new File(assetsDir,"niveau_1_geo_en.gram");
        recognizer.addGrammarSearch(HORSE_SEARCH, HorseGrammar);

        File CowGrammar = new File(assetsDir,"niveau_1_geo_en.gram");
