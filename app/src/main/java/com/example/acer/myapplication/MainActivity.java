    ...
    public void onCreate(Bundle state) {
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,MainActivitychat.class);
                startActivity(i);
        ...
        final MediaPlayer chat_fr = MediaPlayer.create(this,R.raw.chat_fr);
        final MediaPlayer chien_fr = MediaPlayer.create(this,R.raw.chien_fr);
        final MediaPlayer lion_fr = MediaPlayer.create(this,R.raw.lion_fr);
        final MediaPlayer cheval_fr = MediaPlayer.create(this,R.raw.cheval_fr);
        final MediaPlayer vache_fr = MediaPlayer.create(this,R.raw.vache_fr);
        final MediaPlayer goodjob = MediaPlayer.create(this,R.raw.gj);
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("cat")) {
                    ...
                    Toasty.success(this, "I'll give you a " + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("cat",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    final MediaPlayer sound = MediaPlayer.create(this, R.raw.gj);
                    sound.start();


                    Cursor c;
                    c=database.getAllDatajouer("cat");
                    c.moveToFirst();
                    ...
                    Toasty.error(this, "Try one more time Cmoon!", Toast.LENGTH_SHORT, true).show();
                    switchSearch(CAT_SEARCH);
                }
                ...
                if (text.equals("dog")) {
                    ...
                    database.updateData("dog",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("dog");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("lion")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("lion",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("lion");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("horse")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("horse",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("horse");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("cow")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("cow",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("cow");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));

                    int scoreniveauENG=TotalScore/5;

                    database.updateDataNiv("niv1cat1",login_activite.nom,scoreniveauENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("chat")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("cat",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("chien")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("dog",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("lion")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "I'll give you a " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("lion",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("cheval")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, " I'll give you a  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("horse",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("vache")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, " I'll give you a   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("cow",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv1cat1",login_activite.nom,scoreniveauFR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File chatGrammar = new File(assetsDir,"niveau_un_fr.gram");
        recognizer.addGrammarSearch(CHAT_SEARCH, chatGrammar);

        File chienGrammar = new File(assetsDir,"niveau_un_fr.gram");
        recognizer.addGrammarSearch(CHIEN_SEARCH, chienGrammar);

        File lionGrammar = new File(assetsDir,"niveau_un_fr.gram");
        recognizer.addGrammarSearch(LIONFR_SEARCH, lionGrammar);

        File chevalGrammar = new File(assetsDir,"cheval.gram");
        recognizer.addGrammarSearch(CHEVAL_SEARCH, chevalGrammar);

        File vacheGrammar = new File(assetsDir,"niveau_un_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File catGrammar = new File(assetsDir,"cat.gram");
        recognizer.addGrammarSearch(CAT_SEARCH, catGrammar);


        File DogGrammar = new File(assetsDir,"niveau_1_animal_en.gram");
        recognizer.addGrammarSearch(DOG_SEARCH, DogGrammar);

        File LionGrammar = new File(assetsDir,"niveau_1_animal_en.gram");
        recognizer.addGrammarSearch(LION_SEARCH, LionGrammar);

        File HorseGrammar = new File(assetsDir,"niveau_1_animal_en.gram");
        recognizer.addGrammarSearch(HORSE_SEARCH, HorseGrammar);

        File CowGrammar = new File(assetsDir,"cow.gram");
