...
public class Pocket2 extends Activity implements RecognitionListener {
    ...
    CircleImageView b4;
    public static int a;
    public static String extra_number2="sc";
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.pocket2);
        ...
        p2=intent.getIntExtra(MainActivity.extra_number,0);
        ((TextView) findViewById(R.id.caption_text)).setText(""+p2);
        b1 =(Button)findViewById(R.id.speak2);
        b1.setEnabled(false);
        b1.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
               switchSearch(Fr_Search);
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
            Intent i=new Intent(Pocket2.this,Pocket3.class);
            i.putExtra(extra_number2,p2+a);
            onDestroy();
            startActivity(i);
            finish();
        }
        ...
        b3.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Pocket2.this,MainActivity.class);
                startActivity(i);
            }
        });
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Pocket2> activityReference;
        SetupTask(Pocket2 activity) {
            this.activityReference = new WeakReference<>(activity);
        }
        @Override
        protected Exception doInBackground(Void... params) {
            try {
                Assets assets2 = new Assets(activityReference.get());
                File assetDir2 = assets2.syncAssets();
                activityReference.get().setupRecognizer(assetDir2);
            } catch (IOException e) {
                return e;
            }
            return null;
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        if(text.equals("deux")){
          ...
          //  makeText(getApplicationContext(), "Try again    "+text, Toast.LENGTH_SHORT).show();
            Toasty.error(this, ""+a, Toast.LENGTH_SHORT, true).show();
            switchSearch(Fr_Search);
        }
    }
    ...
    public void onEndOfSpeech() {
        if (!recognizer.getSearchName().equals(Fr_Search))
            switchSearch(Fr_Search);
    }
    ...
    public void onBackPressed() {
        Intent i =new Intent(Pocket2.this,startActivity.class);
        onDestroy();
        startActivity(i);
        finish();
