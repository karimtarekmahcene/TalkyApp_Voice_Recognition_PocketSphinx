...
public class Slide extends Activity {
    ...
    private  slideAdapter aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aslideAdapter = new slideAdapter(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide.this);

        View vie = LayoutInflater.from(Slide.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
