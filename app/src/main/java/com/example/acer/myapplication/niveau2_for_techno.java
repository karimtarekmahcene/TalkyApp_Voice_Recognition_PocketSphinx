...
public class niveau2_for_techno extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="en") {
            ...
            if (count == 1) {
                img.setImageResource(R.drawable.stove);
            } else if (count == 2) {
                img.setImageResource(R.drawable.imprimante);
            } else if (count == 3) {
                img.setImageResource(R.drawable.receiver);
            } else if (count == 4) {
                img.setImageResource(R.drawable.application);
            } else if (count == 5) {
                img.setImageResource(R.drawable.ecran);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau2_for_techno.this, Slide_for_techno.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau2_for_techno.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });
        final MediaPlayer shirt = MediaPlayer.create(this,R.raw.stove);
        final MediaPlayer baseball = MediaPlayer.create(this,R.raw.printer);
        final MediaPlayer handball = MediaPlayer.create(this,R.raw.receiver);
        final MediaPlayer racket = MediaPlayer.create(this,R.raw.application);
        final MediaPlayer volleyball = MediaPlayer.create(this,R.raw.screen);

        final MediaPlayer maillot = MediaPlayer.create(this,R.raw.cuisiniere);
        final MediaPlayer baseball_fr = MediaPlayer.create(this,R.raw.imprimante);
        final MediaPlayer handball_fr = MediaPlayer.create(this,R.raw.demofr);
        final MediaPlayer raquette = MediaPlayer.create(this,R.raw.applicationfr);
        final MediaPlayer volleyball_fr = MediaPlayer.create(this,R.raw.ecran);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau2_for_techno> activityReference;
        SetupTask(niveau2_for_techno activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("stove")) {
                    ...
                    database.updateData("stove",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("stove");
                    c.moveToFirst();
                ...
                if (text.equals("printer")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("printer",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("printer");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("receiver")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("demo",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("demo");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("application")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("application",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("application");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("screen")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("ecran",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("ecran");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));

                    int Scoreniv2ENG=TotalScore/5;
                    database.updateDataNiv("niv2cat8",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("cuisinier")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("stove",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("imprimante")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("printer",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("démo")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("demo",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("application")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("application",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("écran")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("ecran",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv2cat8",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File moutonGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_2_techno_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_2_techno_en.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_2_techno_en.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_2_techno_en.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_2_techno_en.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_2_techno_en.gram");
