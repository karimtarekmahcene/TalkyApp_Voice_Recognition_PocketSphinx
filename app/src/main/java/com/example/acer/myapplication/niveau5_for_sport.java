...
public class niveau5_for_sport extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="en") {
            ...
            if (count == 1) {
                ...
                img.setImageResource(R.drawable.ping);
            } else if (count == 4) {
                img.setImageResource(R.drawable.tennis);
            } else if (count == 5) {
                img.setImageResource(R.drawable.billiards);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau5_for_sport.this, Slide_for_sport.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau5_for_sport.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer golf = MediaPlayer.create(this,R.raw.golf);
        final MediaPlayer hockey = MediaPlayer.create(this,R.raw.hockey);
        final MediaPlayer ping = MediaPlayer.create(this,R.raw.ping);
        final MediaPlayer tennis = MediaPlayer.create(this,R.raw.tennis);
        final MediaPlayer billiard = MediaPlayer.create(this,R.raw.billiard);


        final MediaPlayer golf_fr = MediaPlayer.create(this,R.raw.golf_fr);
        final MediaPlayer hockey_fr = MediaPlayer.create(this,R.raw.hockey_fr);
        final MediaPlayer ping_fr = MediaPlayer.create(this,R.raw.ping_fr);
        final MediaPlayer tennis_fr = MediaPlayer.create(this,R.raw.tennis_fr);
        final MediaPlayer billiard_fr = MediaPlayer.create(this,R.raw.billiard_fr);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau5_for_sport> activityReference;
        SetupTask(niveau5_for_sport activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("golf")) {
                    ...
                    database.updateData("golf",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("golf");
                    c.moveToFirst();
                ...
                if (text.equals("hockey")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("hockey",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("hockey");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("ping-pong")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("ping-pong",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("ping-pong");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("tennis")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("tennis",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("tennis");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("billiard")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("billiard",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("billiard");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
            ...
            if (count2 == 1) {
                ...
                if (text.equals("golf")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("golf",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("hockey")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("hockey",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("ping-pong")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("ping-pong",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("tennis")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("tennis",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("billard")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("billiard",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File moutonGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_5_sport_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_5_sport_en.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_5_sport_en.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_5_sport_en.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_5_sport_en.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_5_sport_en.gram");
