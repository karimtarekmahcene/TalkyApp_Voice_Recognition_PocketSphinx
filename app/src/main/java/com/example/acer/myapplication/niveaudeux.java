...
public class
niveaudeux extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveaudeux.this, Slide.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveaudeux.this,MainActivitychat.class);
                startActivity(i);
        ...
        final MediaPlayer monkey = MediaPlayer.create(this,R.raw.monkey);
        final MediaPlayer tiger = MediaPlayer.create(this,R.raw.tiger);
        final MediaPlayer panda = MediaPlayer.create(this,R.raw.panda);
        final MediaPlayer gazelle = MediaPlayer.create(this,R.raw.gazelle);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveaudeux> activityReference;
        SetupTask(niveaudeux activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("sheep")) {
                    ...
                    database.updateData("sheep",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("monkey")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("monkey",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("tiger")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("tiger",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("panda")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("panda",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("gazelle")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("gazelle",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv2cat1",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("gazelle")) {
                    ...
                    database.updateDataNiv("niv2cat1",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File moutonGrammar = new File(assetsDir,"niveau_deux_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_deux_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_deux_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_deux_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"gazellle.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_2_animal_en.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_2_animal_en.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_2_animal_en.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_2_animal_en.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_2_animal_en.gram");
