...
public class Slide3 extends Activity {
    ...
    private  slideAdapter3 aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_art);
        ...
        aslideAdapter = new slideAdapter3(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide3.this);

        View vie = LayoutInflater.from(Slide3.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide3.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
