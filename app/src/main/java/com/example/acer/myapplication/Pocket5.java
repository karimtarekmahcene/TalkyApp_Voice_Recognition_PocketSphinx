...
public class Pocket5 extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.pocket5);
        ...
        p5=intent.getIntExtra(Pocket4.extra_number4,0);
        ((TextView) findViewById(R.id.caption_text)).setText(""+p5);
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i =new Intent(Pocket5.this,Slide.class);
                onDestroy();
                startActivity(i);
                finish();
            }
        ...
        b3.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Pocket5.this,Pocket2.class);
                startActivity(i);
            }
        });
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Pocket5> activityReference;
        SetupTask(Pocket5 activity) {
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        recognizer.addGrammarSearch(DIGITS_SEARCH, cowGrammar);
