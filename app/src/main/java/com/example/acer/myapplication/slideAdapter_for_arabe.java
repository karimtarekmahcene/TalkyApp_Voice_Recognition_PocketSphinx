...
public class slideAdapter_for_arabe extends PagerAdapter {
    ...
    public slideAdapter_for_arabe(Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if (position == 0) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(context, niveau1_for_arabe.class);
            ...
            if(startActivity.langue=="ar") {
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        score.setText("" + Slide_for_arabe.getscoreimage("sheep"));
                        score2.setText("" + Slide_for_arabe.getscoreimage("monkey"));
                        score3.setText("" + Slide_for_arabe.getscoreimage("tiger"));
                        score4.setText("" + Slide_for_arabe.getscoreimage("panda"));
                        score5.setText("" + Slide_for_arabe.getscoreimage("gazelle"));

                        TextView credit1 = (TextView) vie.findViewById(R.id.credit1);
                        credit1.setText("sheep  ");
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_arabe.viewPager.setCurrentItem(1);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == "ar") {
                final int scoreniv=(Slide_for_arabe.getscoreimage("sheep")+ Slide_for_arabe.getscoreimage("monkey")+ Slide_for_arabe.getscoreimage("tiger")+ Slide_for_arabe.getscoreimage("panda")+ Slide_for_arabe.getscoreimage("gazelle"));
        ...
        if(position==1){
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_arabe.getscoreimage("sheep")+ Slide_for_arabe.getscoreimage("monkey")+ Slide_for_arabe.getscoreimage("tiger")+ Slide_for_arabe.getscoreimage("panda")+ Slide_for_arabe.getscoreimage("gazelle"));
            ...
            if(scoreniv>=5){
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i=new Intent(context, niveau2_for_arabe.class);
                        startActivity(context,i,null);
                    }
                });
            }
            ...
            if(startActivity.langue=="ar"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        score.setText(""+ Slide_for_arabe.viewAll("wagon"));
                        score2.setText(""+ Slide_for_arabe.viewAll("ship"));
                        score3.setText(""+ Slide_for_arabe.viewAll("tractor"));
                        score4.setText(""+ Slide_for_arabe.viewAll("canoe"));
                        score5.setText(""+ Slide_for_arabe.viewAll("tank"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_arabe.viewPager.setCurrentItem(2);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == "ar") {
                final int scoreniv1=(Slide_for_arabe.getscoreimage("wagon")+ Slide_for_arabe.getscoreimage("ship")+ Slide_for_arabe.getscoreimage("tractor")+ Slide_for_arabe.getscoreimage("canoe")+ Slide_for_arabe.getscoreimage("tank"));
        ...
        if(position==2) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_arabe.getscoreimage("wagon")+ Slide_for_arabe.getscoreimage("ship")+ Slide_for_arabe.getscoreimage("tractor")+ Slide_for_arabe.getscoreimage("canoe")+ Slide_for_arabe.getscoreimage("tank"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau3_for_arabe.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue=="ar"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+ Slide_for_arabe.getscoreimage("ball"));
                        score2.setText(""+ Slide_for_arabe.getscoreimage("stadium"));
                        score3.setText(""+ Slide_for_arabe.getscoreimage("tribune"));
                        score4.setText(""+ Slide_for_arabe.getscoreimage("player"));
                        score5.setText(""+ Slide_for_arabe.getscoreimage("coach"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_arabe.viewPager.setCurrentItem(3);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == "ar") {
                final int scoreniv2=(Slide_for_arabe.getscoreimage("ball")+ Slide_for_arabe.getscoreimage("stadium")+ Slide_for_arabe.getscoreimage("tribune")+ Slide_for_arabe.getscoreimage("player")+ Slide_for_arabe.getscoreimage("coach"));
        ...
        if(position==3) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_arabe.getscoreimage("ball")+ Slide_for_arabe.getscoreimage("stadium")+ Slide_for_arabe.getscoreimage("tribune")+ Slide_for_arabe.getscoreimage("player")+ Slide_for_arabe.getscoreimage("coach"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau4_for_arabe.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue=="ar"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+ Slide_for_arabe.getscoreimage("bread"));
                        score2.setText(""+ Slide_for_arabe.getscoreimage("carrot"));
                        score3.setText(""+ Slide_for_arabe.getscoreimage("orange"));
                        score4.setText(""+ Slide_for_arabe.getscoreimage("pizza"));
                        score5.setText(""+ Slide_for_arabe.getscoreimage("milk"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_arabe.viewPager.setCurrentItem(4);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == "ar") {
                final int scoreniv3=(Slide_for_arabe.getscoreimage("bread")+ Slide_for_arabe.getscoreimage("carrot")+ Slide_for_arabe.getscoreimage("orange")+ Slide_for_arabe.getscoreimage("pizza")+ Slide_for_arabe.getscoreimage("milk"));
        ...
        if(position==4) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_arabe.getscoreimage("bread")+ Slide_for_arabe.getscoreimage("carrot")+ Slide_for_arabe.getscoreimage("orange")+ Slide_for_arabe.getscoreimage("pizza")+ Slide_for_arabe.getscoreimage("milk"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau5_for_arabe.class);
                        startActivity(context, i, null);
                    }
                });
            }
            if(startActivity.langue=="ar"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+ Slide_for_arabe.getscoreimage("brush"));
                        score2.setText(""+ Slide_for_arabe.getscoreimage("pianist"));
                        score3.setText(""+ Slide_for_arabe.getscoreimage("guitarist"));
                        score4.setText(""+ Slide_for_arabe.getscoreimage("violinist"));
                        score5.setText(""+ Slide_for_arabe.getscoreimage("writer"));

                        TextView  credit1=(TextView)vie.findViewById(R.id.credit1);
                        credit1.setText("brush  ");
                        TextView  credit2=(TextView)vie.findViewById(R.id.credit2);
                        credit2.setText("pianist  ");
                        TextView  credit3=(TextView)vie.findViewById(R.id.credit3);
                        credit3.setText("guitarist ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("violinist ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("writer");
            ...
            if (startActivity.langue == "ar") {
                final int scoreniv4=(Slide_for_arabe.getscoreimage("brush")+ Slide_for_arabe.getscoreimage("pianist")+ Slide_for_arabe.getscoreimage("guitarist")+ Slide_for_arabe.getscoreimage("violinist")+ Slide_for_arabe.getscoreimage("writer"));
