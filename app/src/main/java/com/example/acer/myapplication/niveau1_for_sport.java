...
public class niveau1_for_sport extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau1_for_sport.this, Slide_for_sport.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau1_for_sport.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer ball = MediaPlayer.create(this,R.raw.ball);
        final MediaPlayer stadium = MediaPlayer.create(this,R.raw.stadium);
        final MediaPlayer tribune = MediaPlayer.create(this,R.raw.tribune);
        final MediaPlayer player = MediaPlayer.create(this,R.raw.player);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau1_for_sport> activityReference;
        SetupTask(niveau1_for_sport activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("ball")) {
                    ...
                    database.updateData("ball",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("stadium")) {
                    ...
                    database.updateData("stadium",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("tribune")) {
                    ...
                    //  makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("tribune",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("player")) {
                    ...
                    //  makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("player",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("coach")) {
                    ...
                    // makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("coach",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv1cat7",login_activite.nom,scoreniveauENG,"eng",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("entraineur")) {
                    ...
                    database.updateDataNiv("niv1cat7",login_activite.nom,scoreniveauFR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File chatGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
        recognizer.addGrammarSearch(CHAT_SEARCH, chatGrammar);

        File chienGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
        recognizer.addGrammarSearch(CHIEN_SEARCH, chienGrammar);

        File lionGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
        recognizer.addGrammarSearch(LIONFR_SEARCH, lionGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
        recognizer.addGrammarSearch(CHEVAL_SEARCH, chevalGrammar);

        File vacheGrammar = new File(assetsDir,"niveau_1_sport_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File catGrammar = new File(assetsDir,"niveau_1_sport_en.gram");
        recognizer.addGrammarSearch(CAT_SEARCH, catGrammar);


        File DogGrammar = new File(assetsDir,"niveau_1_sport_en.gram");
        recognizer.addGrammarSearch(DOG_SEARCH, DogGrammar);

        File LionGrammar = new File(assetsDir,"niveau_1_sport_en.gram");
        recognizer.addGrammarSearch(LION_SEARCH, LionGrammar);

        File HorseGrammar = new File(assetsDir,"niveau_1_sport_en.gram");
        recognizer.addGrammarSearch(HORSE_SEARCH, HorseGrammar);

        File CowGrammar = new File(assetsDir,"niveau_1_sport_en.gram");
