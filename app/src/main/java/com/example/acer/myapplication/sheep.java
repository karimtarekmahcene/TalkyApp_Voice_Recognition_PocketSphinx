...
public class sheep extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        p2=intent.getIntExtra(monkey.extra_number,0);
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(sheep.this,Slide.class);
                onDestroy();
                startActivity(i);
                finish();
            }
        ...
        b3.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(sheep.this,MainActivity.class);
                startActivity(i);
            }
        });
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<sheep> activityReference;
        SetupTask(sheep activity) {
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File catGrammar = new File(assetsDir,"sheep.gram");
