...
public class monkey extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(monkey.this,sheep.class);
                i.putExtra(extra_number,a);
                onDestroy();
                startActivity(i);
                finish();
            }
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<monkey> activityReference;
        SetupTask(monkey activity) {
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File catGrammar = new File(assetsDir,"monkey.gram");
    ...
    public void onBackPressed() {
        Intent i =new Intent(monkey.this,Slide.class);
        onDestroy();
        startActivity(i);
        finish();
