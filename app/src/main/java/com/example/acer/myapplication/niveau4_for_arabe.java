...
public class niveau4_for_arabe extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="ar") {
            ...
            if (count == 1) {
                ...
                img.setImageResource(R.drawable.yelow);
            } else if (count == 5) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="ar") {
                    if (count == 5) {
                        Intent i = new Intent(niveau4_for_arabe.this, Slide_for_arabe.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau4_for_arabe.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer wagon = MediaPlayer.create(this,R.raw.ahmar);
        final MediaPlayer ship = MediaPlayer.create(this,R.raw.akhdar);
        final MediaPlayer tractor = MediaPlayer.create(this,R.raw.azrak);
        final MediaPlayer pirogue = MediaPlayer.create(this,R.raw.asfar);
        final MediaPlayer tank = MediaPlayer.create(this,R.raw.abyad);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau4_for_arabe> activityReference;
        SetupTask(niveau4_for_arabe activity) {
        ...
        if (startActivity.langue == "ar") {
            ...
            if (count == 1) {
                ...
                if (text.equals("AHMAR")) {
                    ...
                    database.updateData("bread",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("AKHDAR")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("carrot",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("AZRAQ")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("orange",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("ASFAR")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("pizza",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("ABYAD")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("milk",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_4_ar.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_4_ar.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_4_ar.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_4_ar.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_4_ar.gram");
