...
public class slideAdapter_for_sport extends PagerAdapter {
    ...
    public slideAdapter_for_sport(Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if (position == 0) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i=new Intent(context,niveau1_for_sport.class);
            ...
            if(startActivity.langue=="en") {
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        score.setText("" + Slide_for_sport.getscoreimage("ball"));
                        score2.setText("" + Slide_for_sport.getscoreimage("stadium"));
                        score3.setText("" + Slide_for_sport.getscoreimage("tribune"));
                        score4.setText("" + Slide_for_sport.getscoreimage("player"));
                        score5.setText("" + Slide_for_sport.getscoreimage("coach"));

                        TextView credit1 = (TextView) vie.findViewById(R.id.credit1);
                        credit1.setText("ball  ");
                        TextView credit2 = (TextView) vie.findViewById(R.id.credit2);
                        credit2.setText("stadium  ");
                        TextView credit3 = (TextView) vie.findViewById(R.id.credit3);
                        credit3.setText("tribune  ");
                        TextView credit4 = (TextView) vie.findViewById(R.id.credit4);
                        credit4.setText("player  ");
                        TextView credit5 = (TextView) vie.findViewById(R.id.credit5);
                        credit5.setText("coach");
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_sport.viewPager.setCurrentItem(1);
                                a.cancel();
                            }
                        });
            ...
            if(startActivity.langue=="fr"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        TextView credit1 = (TextView) vie.findViewById(R.id.credit1);
                        credit1.setText("ballon  ");
                        TextView credit2 = (TextView) vie.findViewById(R.id.credit2);
                        credit2.setText("stade  ");
                        TextView credit3 = (TextView) vie.findViewById(R.id.credit3);
                        credit3.setText("tribune  ");
                        TextView credit4 = (TextView) vie.findViewById(R.id.credit4);
                        credit4.setText("joueur  ");
                        TextView credit5 = (TextView) vie.findViewById(R.id.credit5);
                        credit5.setText("entrain");
            ...
            if (startActivity.langue == "en") {
                final int scoreniv=(Slide_for_sport.getscoreimage("ball")+Slide_for_sport.getscoreimage("stadium")+Slide_for_sport.getscoreimage("tribune")+Slide_for_sport.getscoreimage("player")+Slide_for_sport.getscoreimage("coach"));
        ...
        if(position==1){
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_sport.getscoreimage("ball")+Slide_for_sport.getscoreimage("stadium")+Slide_for_sport.getscoreimage("tribune")+Slide_for_sport.getscoreimage("player")+Slide_for_sport.getscoreimage("coach"));
            ...
            if(scoreniv>=5){
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i=new Intent(context,niveau2_for_sport.class);
                        startActivity(context,i,null);
                    }
                });
            }
            ...
            if(startActivity.langue=="en"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        TextView  credit1=(TextView)vie.findViewById(R.id.credit1);
                        credit1.setText("shirt  ");
                        TextView  credit2=(TextView)vie.findViewById(R.id.credit2);
                        credit2.setText("baseball  ");
                        TextView  credit3=(TextView)vie.findViewById(R.id.credit3);
                        credit3.setText("handball  ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("racket  ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("volley");

                        score.setText(""+Slide_for_sport.viewAll("shirt"));
                        score2.setText(""+Slide_for_sport.viewAll("baseball"));
                        score3.setText(""+Slide_for_sport.viewAll("handball"));
                        score4.setText(""+Slide_for_sport.viewAll("racket"));
                        score5.setText(""+Slide_for_sport.viewAll("volleyball"));
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_sport.viewPager.setCurrentItem(2);
                                a.cancel();
                            }
                        });
            ...
            if (startActivity.langue == "fr") {
                final int scoreniv1=(Slide_for_sport.getscoreimage("shirt")+Slide_for_sport.getscoreimage("baseball")+Slide_for_sport.getscoreimage("handball")+Slide_for_sport.getscoreimage("racket")+Slide_for_sport.getscoreimage("volleyball"));
        ...
        if(position==2) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_sport.getscoreimage("shirt")+Slide_for_sport.getscoreimage("baseball")+Slide_for_sport.getscoreimage("handball")+Slide_for_sport.getscoreimage("racket")+Slide_for_sport.getscoreimage("volleyball"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau3_for_sport.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue=="en"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_sport.getscoreimage("goal"));
                        score2.setText(""+Slide_for_sport.getscoreimage("basketball"));
                        score3.setText(""+Slide_for_sport.getscoreimage("club"));
                        score4.setText(""+Slide_for_sport.getscoreimage("shorts"));
                        score5.setText(""+Slide_for_sport.getscoreimage("shoe"));

                        TextView  credit1=(TextView)vie.findViewById(R.id.credit1);
                        credit1.setText("goal  ");
                        TextView  credit2=(TextView)vie.findViewById(R.id.credit2);
                        credit2.setText("basketball  ");
                        TextView  credit3=(TextView)vie.findViewById(R.id.credit3);
                        credit3.setText("club  ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("shorts  ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("shoe");
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_sport.viewPager.setCurrentItem(3);
                                a.cancel();
                            }
                        });
            ...
            if(startActivity.langue=="fr"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        credit3.setText("club  ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("short  ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("soulier");
            ...
            if (startActivity.langue == "en") {
                final int scoreniv2=(Slide_for_sport.getscoreimage("goal")+Slide_for_sport.getscoreimage("basketball")+Slide_for_sport.getscoreimage("club")+Slide_for_sport.getscoreimage("shorts")+Slide_for_sport.getscoreimage("shoe"));
        ...
        if(position==3) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_sport.getscoreimage("goal")+Slide_for_sport.getscoreimage("basketball")+Slide_for_sport.getscoreimage("club")+Slide_for_sport.getscoreimage("shorts")+Slide_for_sport.getscoreimage("shoe"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau4_for_sport.class);
                        startActivity(context, i, null);
                    }
                });
            }
            ...
            if(startActivity.langue=="en"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_sport.getscoreimage("gloves"));
                        score2.setText(""+Slide_for_sport.getscoreimage("sport"));
                        score3.setText(""+Slide_for_sport.getscoreimage("racing"));
                        score4.setText(""+Slide_for_sport.getscoreimage("victory"));
                        score5.setText(""+Slide_for_sport.getscoreimage("loss"));

                        TextView  credit1=(TextView)vie.findViewById(R.id.credit1);
                        credit1.setText("gloves  ");
                        TextView  credit2=(TextView)vie.findViewById(R.id.credit2);
                        credit2.setText("sport  ");
                        TextView  credit3=(TextView)vie.findViewById(R.id.credit3);
                        credit3.setText("racing  ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("victory  ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("loss");
                        ...
                        next.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Slide_for_sport.viewPager.setCurrentItem(4);
                                a.cancel();
                            }
                        });
            ...
            if(startActivity.langue=="fr"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("victoire  ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("perte");
            ...
            if (startActivity.langue == "en") {
                final int scoreniv3=(Slide_for_sport.getscoreimage("gloves")+Slide_for_sport.getscoreimage("sport")+Slide_for_sport.getscoreimage("racing")+Slide_for_sport.getscoreimage("victory")+Slide_for_sport.getscoreimage("loss"));
        ...
        if(position==4) {
            final   int[] mProgressStatus= {0};
            int scoreniv=(Slide_for_sport.getscoreimage("gloves")+Slide_for_sport.getscoreimage("sport")+Slide_for_sport.getscoreimage("racing")+Slide_for_sport.getscoreimage("victory")+Slide_for_sport.getscoreimage("loss"));
            if (scoreniv >= 5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(context, niveau5_for_sport.class);
                        startActivity(context, i, null);
                    }
                });
            }
            if(startActivity.langue=="en"){
                ...
                flag.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //String sc=   database.getImagescore("cat");
                        score.setText(""+Slide_for_sport.getscoreimage("golf"));
                        score2.setText(""+Slide_for_sport.getscoreimage("hockey"));
                        score3.setText(""+Slide_for_sport.getscoreimage("ping-pong"));
                        score4.setText(""+Slide_for_sport.getscoreimage("tennis"));
                        score5.setText(""+Slide_for_sport.getscoreimage("billiard"));

                        TextView  credit1=(TextView)vie.findViewById(R.id.credit1);
                        credit1.setText("golf  ");
                        TextView  credit2=(TextView)vie.findViewById(R.id.credit2);
                        credit2.setText("hockey  ");
                        TextView  credit3=(TextView)vie.findViewById(R.id.credit3);
                        credit3.setText("ping-pong ");
                        TextView  credit4=(TextView)vie.findViewById(R.id.credit4);
                        credit4.setText("tennis ");
                        TextView  credit5=(TextView)vie.findViewById(R.id.credit5);
                        credit5.setText("billiard");
            ...
            if (startActivity.langue == "en") {
                final int scoreniv4=(Slide_for_sport.getscoreimage("golf")+Slide_for_sport.getscoreimage("hockey")+Slide_for_sport.getscoreimage("ping-pong")+Slide_for_sport.getscoreimage("tennis")+Slide_for_sport.getscoreimage("billiard"));
