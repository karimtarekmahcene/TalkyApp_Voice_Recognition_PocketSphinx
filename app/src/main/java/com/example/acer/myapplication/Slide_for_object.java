...
public class Slide_for_object extends Activity {

    public static ViewPager viewPager;
    private LinearLayout linearLayout;
    private TextView ndot[];
    private  slideAdapter_for_object aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_object);
        ...
        aslideAdapter = new slideAdapter_for_object(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide_for_object.this);

        View vie = LayoutInflater.from(Slide_for_object.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide_for_object.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
