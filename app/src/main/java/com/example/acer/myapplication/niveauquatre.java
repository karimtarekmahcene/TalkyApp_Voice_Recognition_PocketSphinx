...
public class niveauquatre extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveauquatre.this, Slide.class);
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveauquatre.this,MainActivitychat.class);
                startActivity(i);

            }
        });
        final MediaPlayer donkey = MediaPlayer.create(this,R.raw.donkey);
        final MediaPlayer fox = MediaPlayer.create(this,R.raw.fox);
        final MediaPlayer kitchen = MediaPlayer.create(this,R.raw.kitchen);
        final MediaPlayer snake = MediaPlayer.create(this,R.raw.snake);
        final MediaPlayer zebra = MediaPlayer.create(this,R.raw.zebra);


        final MediaPlayer donkey_fr = MediaPlayer.create(this,R.raw.ana_fr);
        final MediaPlayer fox_fr = MediaPlayer.create(this,R.raw.fox_fr);
        final MediaPlayer kitchen_fr = MediaPlayer.create(this,R.raw.kitchen_fr);
        final MediaPlayer snake_fr = MediaPlayer.create(this,R.raw.snake_fr);
        final MediaPlayer zebra_fr = MediaPlayer.create(this,R.raw.zebra_fr);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveauquatre> activityReference;
        SetupTask(niveauquatre activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("donkey")) {
                    ...
                    database.updateData("donkey",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("donkey");
                    c.moveToFirst();
                ...
                if (text.equals("fox")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("fox",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("fox");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("kitchen")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("kitchen",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("kitchen");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("snake")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("snake",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("snake");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("zebra")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("zebra",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("zebra");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));

                    int Scoreniv2ENG=TotalScore/5;
                    database.updateDataNiv("niv4cat1",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("âne")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("donkey",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("renard")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("fox",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("poule")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("kitchen",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("serpent")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("snake",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("zèbre")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("zebra",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv4cat1",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File moutonGrammar = new File(assetsDir,"niveau_quatre_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_quatre_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_quatre_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_quatre_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"zebre.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_4_animal_en.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);

        File monkeyGrammar = new File(assetsDir,"niveau_4_animal_en.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_4_animal_en.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_4_animal_en.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_4_animal_en.gram");
