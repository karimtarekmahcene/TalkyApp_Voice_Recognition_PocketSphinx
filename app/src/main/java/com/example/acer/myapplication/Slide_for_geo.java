...
public class Slide_for_geo extends Activity {

    public static ViewPager viewPager;
    private LinearLayout linearLayout;
    private TextView ndot[];
    private  slideAdapter_for_geo aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_geography);
        ...
        aslideAdapter = new slideAdapter_for_geo(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide_for_geo.this);

        View vie = LayoutInflater.from(Slide_for_geo.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide_for_geo.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
