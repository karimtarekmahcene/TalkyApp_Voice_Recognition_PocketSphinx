...
public class Slide2 extends Activity {
    ...
    private  slideAdapter2 aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_nour);
        ...
        aslideAdapter = new slideAdapter2(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide2.this);

        View vie = LayoutInflater.from(Slide2.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide2.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
