...
public class Pocket4 extends Activity implements RecognitionListener {
    ...
    public static String extra_number4="sc";
    public static int p4;
    public static int a;
public static int som3;
    @Override
    public void onCreate(Bundle state) {
        ...
        setContentView(R.layout.pocket4);
        ...
        p4=intent.getIntExtra(Pocket3.extra_number3,0);
        ((TextView) findViewById(R.id.caption_text)).setText(""+p4);
        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i =new Intent(Pocket4.this,Pocket5.class);
                i.putExtra(extra_number4,p4+a);
                onDestroy();
                startActivity(i);
                finish();
            }
        ...
        b3.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Pocket4.this,Pocket2.class);
                startActivity(i);
            }
        });
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Pocket4> activityReference;
        SetupTask(Pocket4 activity) {
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File horseGrammar = new File(assetsDir,"horse.gram");
        recognizer.addGrammarSearch(DIGITS_SEARCH, horseGrammar);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Pocket4.this,Slide.class);
        onDestroy();
        startActivity(i);
        finish();
