...
public class niveau2_for_arabe extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="ar") {
            ...
            if (count == 1) {
                img.setImageResource(R.drawable.toufah);
            } else if (count == 2) {
                ...
                img.setImageResource(R.drawable.dajajatun);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="ar") {
                    if (count == 5) {
                        Intent i = new Intent(niveau2_for_arabe.this, Slide_for_arabe.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau2_for_arabe.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer wagon = MediaPlayer.create(this,R.raw.toufah);
        final MediaPlayer ship = MediaPlayer.create(this,R.raw.boutoukal);
        final MediaPlayer tractor = MediaPlayer.create(this,R.raw.laymoun);
        final MediaPlayer pirogue = MediaPlayer.create(this,R.raw.halib);
        final MediaPlayer tank = MediaPlayer.create(this,R.raw.dajajatun);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau2_for_arabe> activityReference;
        SetupTask(niveau2_for_arabe activity) {
        ...
        if (startActivity.langue == "ar") {
            ...
            if (count == 1) {
                ...
                if (text.equals("TOUFFAH")) {
                    ...
                    database.updateData("wagon",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("BOURTOUQAL")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("ship",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("LAYMOUN")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("tractor",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("HALIB")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("pirogue",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("DAJAJATUN")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("tank",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv2cat10",login_activite.nom,Scoreniv2ENG,"ar",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("char")) {
                    ...
                    database.updateDataNiv("niv2cat10",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_2_ar.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_2_ar.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_2_ar.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_2_ar.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_2_ar.gram");
