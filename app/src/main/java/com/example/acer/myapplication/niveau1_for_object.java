...
public class niveau1_for_object extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="en") {
            ...
            if (count == 1) {
                ...
                img.setImageResource(R.drawable.stair);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau1_for_object.this, Slide_for_object.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau1_for_object.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer bed = MediaPlayer.create(this,R.raw.bed);
        final MediaPlayer table = MediaPlayer.create(this,R.raw.table);
        final MediaPlayer door = MediaPlayer.create(this,R.raw.door);
        final MediaPlayer picture = MediaPlayer.create(this,R.raw.picture);
        final MediaPlayer stair = MediaPlayer.create(this,R.raw.stair);


        final MediaPlayer bed_fr= MediaPlayer.create(this,R.raw.bed_fr);
        final MediaPlayer table_fr = MediaPlayer.create(this,R.raw.table_fr);
        final MediaPlayer door_fr = MediaPlayer.create(this,R.raw.door_fr);
        final MediaPlayer picture_fr = MediaPlayer.create(this,R.raw.picture_fr);
        final MediaPlayer stair_fr = MediaPlayer.create(this,R.raw.stair_fr);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau1_for_object> activityReference;
        SetupTask(niveau1_for_object activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("bed")) {
                    ...
                    database.updateData("bed",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("bed");
                    c.moveToFirst();
                ...
                if (text.equals("table")) {
                    ...
                    database.updateData("table",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("table");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("door")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("door",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    sound.start();
                    Cursor c;
                    c=database.getAllDatajouer("door");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("picture")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("picture",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("picture");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));
                ...
                if (text.equals("stair")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("stair",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("stair");
                    c.moveToFirst();
                    TotalScore+=Integer.parseInt(c.getString(0));

                    int scoreniveauENG=TotalScore/5;

                    database.updateDataNiv("niv1cat6",login_activite.nom,scoreniveauENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("lit")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("bed",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("table")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("table",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("porte")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("door",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("image")) {
                    ...
                    //  makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "  " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("picture",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("escalier")) {
                    ...
                    // makeText(getApplicationContext(), ""+"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "   " + a+"   ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("stair",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv1cat6",login_activite.nom,scoreniveauFR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File chatGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
        recognizer.addGrammarSearch(CHAT_SEARCH, chatGrammar);

        File chienGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
        recognizer.addGrammarSearch(CHIEN_SEARCH, chienGrammar);

        File lionGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
        recognizer.addGrammarSearch(LIONFR_SEARCH, lionGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
        recognizer.addGrammarSearch(CHEVAL_SEARCH, chevalGrammar);

        File vacheGrammar = new File(assetsDir,"niveau_1_objet_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File catGrammar = new File(assetsDir,"niveau_1_obj_en.gram");
        recognizer.addGrammarSearch(CAT_SEARCH, catGrammar);


        File DogGrammar = new File(assetsDir,"niveau_1_obj_en.gram");
        recognizer.addGrammarSearch(DOG_SEARCH, DogGrammar);

        File LionGrammar = new File(assetsDir,"niveau_1_obj_en.gram");
        recognizer.addGrammarSearch(LION_SEARCH, LionGrammar);

        File HorseGrammar = new File(assetsDir,"niveau_1_obj_en.gram");
        recognizer.addGrammarSearch(HORSE_SEARCH, HorseGrammar);

        File CowGrammar = new File(assetsDir,"niveau_1_obj_en.gram");
