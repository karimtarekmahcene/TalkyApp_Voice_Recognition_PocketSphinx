...
public class Slide_for_medecine extends Activity {

    public static ViewPager viewPager;
    private LinearLayout linearLayout;
    private TextView ndot[];
    private  slideAdapter_for_medecine aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_medecine);
        ...
        aslideAdapter = new slideAdapter_for_medecine(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide_for_medecine.this);

        View vie = LayoutInflater.from(Slide_for_medecine.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide_for_medecine.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
