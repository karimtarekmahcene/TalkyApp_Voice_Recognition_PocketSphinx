...
public class Slide_for_sport extends Activity {

    public static ViewPager viewPager;
    private LinearLayout linearLayout;
    private TextView ndot[];
    private  slideAdapter_for_sport aslideAdapter;
    private Button b10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slide_for_sport);
        ...
        aslideAdapter = new slideAdapter_for_sport(this);
...
String kaka="";
    ...
    public  void dialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(Slide_for_sport.this);

        View vie = LayoutInflater.from(Slide_for_sport.this).inflate(R.layout.dialog_syllabus, null);
    ...
    public void onBackPressed() {
        Intent i =new Intent(Slide_for_sport.this,MainActivity4.class);
        onDestroy();
        startActivity(i);
    }
}
