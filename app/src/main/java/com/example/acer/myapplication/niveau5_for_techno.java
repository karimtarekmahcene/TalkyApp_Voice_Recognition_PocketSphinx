...
public class niveau5_for_techno extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="en") {
            ...
            if (count == 1) {
                img.setImageResource(R.drawable.montre);
            } else if (count == 2) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="en") {
                    if (count == 5) {
                        Intent i = new Intent(niveau5_for_techno.this, Slide_for_techno.class);
                        i.putExtra("sound", 10);
                        onDestroy();
                        startActivity(i);
                        finish();
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau5_for_techno.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });

        final MediaPlayer golf = MediaPlayer.create(this,R.raw.watch);
        final MediaPlayer hockey = MediaPlayer.create(this,R.raw.mouse);
        final MediaPlayer ping = MediaPlayer.create(this,R.raw.keyboard);
        final MediaPlayer tennis = MediaPlayer.create(this,R.raw.screen);
        final MediaPlayer billiard = MediaPlayer.create(this,R.raw.blender);


        final MediaPlayer golf_fr = MediaPlayer.create(this,R.raw.montre);
        final MediaPlayer hockey_fr = MediaPlayer.create(this,R.raw.souris);
        final MediaPlayer ping_fr = MediaPlayer.create(this,R.raw.clavier);
        final MediaPlayer tennis_fr = MediaPlayer.create(this,R.raw.ecran);
        final MediaPlayer billiard_fr = MediaPlayer.create(this,R.raw.mixeur);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau5_for_techno> activityReference;
        SetupTask(niveau5_for_techno activity) {
        ...
        if (startActivity.langue == "en") {
            ...
            if (count == 1) {
                ...
                if (text.equals("watch")) {
                    ...
                    database.updateData("montre",login_activite.nom,a,"eng",difuculte);
                    b1.setEnabled(false);
                    ...
                    Cursor c;
                    c=database.getAllDatajouer("montre");
                    c.moveToFirst();
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("blender")) {
                    ...
                    database.updateDataNiv("niv5cat8",login_activite.nom,Scoreniv2ENG,"eng",difuculte);
            ...
            if (count2 == 1) {
                ...
                if (text.equals("montre")) {
                    ...
                    //  makeText(getApplicationContext(), "" +" "+ a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a +"  ", Toast.LENGTH_SHORT, true).show();
                    database.updateData("montre",login_activite.nom,a,"fr",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("mixeur")) {
                    ...
                    database.updateDataNiv("niv5cat8",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File moutonGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_5_techno_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_5_techno_en.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_5_techno_en.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_5_techno_en.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_5_techno_en.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_5_techno_en.gram");
