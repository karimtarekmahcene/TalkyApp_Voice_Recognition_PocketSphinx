...
public class niveau5_for_arabe extends Activity implements RecognitionListener {
    ...
    public void onCreate(Bundle state) {
        ...
        if(startActivity.langue=="ar") {
            ...
            if (count == 1) {
                ...
                img.setImageResource(R.drawable.sis);
            }
        }
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(startActivity.langue=="ar") {
                    if (count == 5) {
                        Intent i = new Intent(niveau5_for_arabe.this, Slide_for_arabe.class);
        ...
        aideb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(niveau5_for_arabe.this,enter_ip_add_chat.class);
                startActivity(i);

            }
        });
        final MediaPlayer donkey = MediaPlayer.create(this,R.raw.omi);
        final MediaPlayer fox = MediaPlayer.create(this,R.raw.jaddi);
        final MediaPlayer kitchen = MediaPlayer.create(this,R.raw.jaddati);
        final MediaPlayer snake = MediaPlayer.create(this,R.raw.akhi);
        final MediaPlayer zebra = MediaPlayer.create(this,R.raw.okhti);
    ...
    private class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<niveau5_for_arabe> activityReference;
        SetupTask(niveau5_for_arabe activity) {
        ...
        if (startActivity.langue == "ar") {
            ...
            if (count == 1) {
                ...
                if (text.equals("&OUMI")) {
                    ...
                    database.updateData("brush",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("JADI")) {
                    ...
                    //  makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a+"  " , Toast.LENGTH_SHORT, true).show();
                    database.updateData("pianist",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("JADDATI")) {
                    ...
                    //  makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("guitarist",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("AKHI")) {
                    ...
                    //  makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("violinist",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                ...
                if (text.equals("OUKHTI")) {
                    ...
                    // makeText(getApplicationContext(), "" +"  " + a, Toast.LENGTH_SHORT).show();
                    Toasty.success(this, "" + a, Toast.LENGTH_SHORT, true).show();
                    database.updateData("writer",login_activite.nom,a,"ar",difuculte);
                    b1.setEnabled(false);
                    ...
                    database.updateDataNiv("niv5cat10",login_activite.nom,Scoreniv2ENG,"ar",difuculte);
...
//                img.setImageResource(R.drawable.dog_nike);
                ...
                if (text.equals("écrivain")) {
                    ...
                    database.updateDataNiv("niv5cat10",login_activite.nom,scoreniveau2FR,"fr",difuculte);
    ...
    private void setupRecognizer(File assetsDir) throws IOException {
        ...
        File frGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
        recognizer.addGrammarSearch(Fr_Search, frGrammar);

        File moutonGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
        recognizer.addGrammarSearch(MOUTON_SEARCH, moutonGrammar);

        File singeGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
        recognizer.addGrammarSearch(SINGE_SEARCH, singeGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
        recognizer.addGrammarSearch(TIGERFR_SEARCH, tigerGrammar);

        File chevalGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
        recognizer.addGrammarSearch(PANDAFR_SEARCH, chevalGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_un_art_fr.gram");
    ...
    private void setupRecognizere(File assetsDir) throws IOException {
        ...
        // Create grammar-based search for digit recognition
        File sheepGrammar = new File(assetsDir,"niveau_5_ar.gram");
        recognizer.addGrammarSearch(SHEEP_SEARCH, sheepGrammar);


        File monkeyGrammar = new File(assetsDir,"niveau_5_ar.gram");
        recognizer.addGrammarSearch(MONKEY_SEARCH, monkeyGrammar);

        File tigerGrammar = new File(assetsDir,"niveau_5_ar.gram");
        recognizer.addGrammarSearch(TIGER_SEARCH, tigerGrammar);

        File pandaGrammar = new File(assetsDir,"niveau_5_ar.gram");
        recognizer.addGrammarSearch(PANDA_SEARCH, pandaGrammar);

        File gazelleGrammar = new File(assetsDir,"niveau_5_ar.gram");
